...
'data.status' => 'required|string|in:active,conger',]);


mount(function(StaffMedical $staff){


     $this->data=$staff->toArray();
});

with(fn () => ['users' => \App\Models\User::all(),'departements' => \App\Models\Departement::all()]);
...
$update= function(){
    ...
    try{
        ...
        $test= \App\Models\StaffMedical::find($this->data['id'])->update($this->data);
...
<div class="content">
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <h4 class="page-title">Modifier Doctor</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
